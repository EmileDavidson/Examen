...
Shader "Game/Ground"
{
	Properties
	{
		...
		_JointColor("Joint Color", Color) = (0,0,0,0)
	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 triplanar8 = TriplanarSampling8( _Sidetexture, worldPos, WorldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float4 temp_output_68_0 = ( ( _TileColor * triplanar8.x ) + ( _JointColor * ( 1.0 - triplanar8.r ) ) );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 triplanar8 = TriplanarSampling8( _Sidetexture, ase_worldPos, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float4 temp_output_68_0 = ( ( _TileColor * triplanar8.x ) + ( _JointColor * ( 1.0 - triplanar8.r ) ) );
